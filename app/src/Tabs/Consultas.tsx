import { VStack, Divider, Image, ScrollView, useToast } from 'native-base';
...
export default function Consultas({ navigation }: NavigationProps<'Consultas'>){
  ...
  return(
    <ScrollView p="5">
      ...
      <Titulo color="green.800">Avaliações</Titulo>
      <Botao mt={5} mb={5}>Inserir nota de avaliação</Botao>

      <Titulo color="green.800" fontSize="lg" alignSelf="flex-start" mb={2}>SEAB - Sistema de Avaliação da Educação Básica</Titulo>
      ...
      <Titulo color="green.800" fontSize="lg" alignSelf="flex-start" mb={2}>INEP - Instituto Nacional de Estudos e Pesquisas</Titulo>
